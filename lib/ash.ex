defmodule Mix.Ash do
  ...
  ## Examples
      ...
      iex> Mix.Ash.inflect("Admin.User")
      [alias: "User",
       human: "User",
       base: "Ash",
       web_module: "AshWeb",
       module: "Ash.Admin.User",
       scoped: "Admin.User",
       singular: "user",
       path: "admin/user"]

      iex> Mix.Ash.inflect("Admin.SuperUser")
      [alias: "SuperUser",
       human: "Super user",
       base: "Ash",
       web_module: "AshWeb",
       module: "Ash.Admin.SuperUser",
